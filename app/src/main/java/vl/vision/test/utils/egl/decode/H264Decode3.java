 ...
 */
public class H264Decode3 extends BaseDecode {
    public static final String TAG = H264Decode3.class.getSimpleName();
    ...
    public H264Decode3(Surface surface, File file) {
    ...
    public H264Decode3(Surface surface, File file, boolean loop) {
        this(surface, file);
        this.mLoop = loop;
    }
    ...
    public void onCreate() {
        try {
            ...
            LogUtils.d(TAG, "onCreate, frameRate: " + mFps + ",mWidth: " + mWidth + ",mHeight: " + mHeight);
